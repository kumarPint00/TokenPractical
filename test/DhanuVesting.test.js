...
contract("DhanuVesting Contract", accounts => {
  let tokenInstance = null;

  before(async () => {
    tokenInstance = await DhanuVesting.deployed();
  });
  ...
  // //Testing the Dhanu Token Contract
  ...
  //   const actualSupply = ether('500_000_000') 
  ...
  //   const totalSupply = ether('500_000_000')
...
//     const user1_amount = ether('77_000_000');
//     const user2_amount = ether('59_000_000');
//     const user3_amount = ether('148_500_000');
   
//     const user7_amount = ether('23_000_000')
//     const user8_amount = ether('10_500_000')
//     const user9_amount = ether('23_000_000')
...
//     const user4_amount = ether('50_000_000')
//     const user5_amount = ether('41_000_000')
//     const user6_amount = ether('68_000_000')
